...
$sql = "SELECT * FROM Category LIMIT 4"; // Adjust as needed
...
<div class="container">
    <?php foreach ($categories as $category): ?>
        <div class="category-box" onclick="window.location.href='vendors.php?category_id=<?php echo $category['CategoryID']; ?>'">
            <img src="<?php echo $category['ImageURL']; ?>" alt="<?php echo $category['CategoryName']; ?>"> <!-- Adjust as needed -->
